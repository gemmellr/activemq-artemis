      ...
      synchronized (session.getState()) {
         try {
            ...
            if (session.getState() != null) {
                ...
                */
               if (clientId != null && session.getSessionStateManager().isClientConnected(clientId, session.getConnection())) {
                  session.getSessionStateManager().removeConnectedClient(clientId);
               }
            }
         }
      }
